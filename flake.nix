            ...
            ({ pkgs, config, lib, ... }:
              ...
              in
              {
                enterShell = ''
                  ...
                  echo "initial setup:  composer setup; APP_ENV=prod bin/console framework:demodata"
                  echo "install plugin:  bin/console plugin:install -a Superfusion"
                  echo "install plugin:  bin/console plugin:update Superfusion"
                  echo
                  echo "==="
                  echo
                '';
